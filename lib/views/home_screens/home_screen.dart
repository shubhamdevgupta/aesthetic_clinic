...
class _HomeScreenState extends State<HomeScreen> {
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, length) {
                      ...
                      return topChoiceItem(recommended.name, recommended.image,context);
                    },
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, length) {
                      ...
                      return topChoiceItem(personalize.name, personalize.image,context);
                    },
                  ),
                ),
              ],
  ...
  static Widget topChoiceItem(String title, String imageUrl,BuildContext context) {
    return InkWell(
      onTap: (){
        showModalBottomSheet(
          ...
          builder: (context) => ServicePopup(
            ...
            duration: "30 Mins",
            imageUrl:
            "https://yourimageurl.com/sample.jpg",
          ),
        );
      },
      child: Container(
...
class ServiceItem extends StatelessWidget {
  ...
  const ServiceItem({super.key, required this.imageUrl, required this.label,required this.serviceID});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>ServiceDetailScreen(serviceId: serviceID)));
      },
      child: Container(
        width: 90,
        margin: const EdgeInsets.only(right: 12),
