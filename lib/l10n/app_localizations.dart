...
abstract class AppLocalizations {
  ...
  /// No description provided for @sendOtpMsg.
  ///
  /// In en, this message translates to:
  /// **'We\'ll whatsapp you to confirm your number'**
  String get sendOtpMsg;
  ...
  /// No description provided for @verifyCodeMsg.
  ///
  /// In en, this message translates to:
  /// **'Enter Verification code that was send to'**
  String get verifyCodeMsg;
  ...
  ///
  /// In en, this message translates to:
  /// **'Please enter the one-time code sent to your WhatsApp'**
  String get otpMsg;
